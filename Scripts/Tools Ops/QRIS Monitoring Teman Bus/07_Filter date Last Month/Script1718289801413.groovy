...
WebUI.setText(findTestObject('Tools Ops/QRIS Monitoring Teman Bus/input_StartDate'), '01-05-2024')

WebUI.click(findTestObject('Tools Ops/QRIS Monitoring Teman Bus/activeDay'))

WebUI.setText(findTestObject('Tools Ops/QRIS Monitoring Teman Bus/input_EndDate'), '31-05-2024')
