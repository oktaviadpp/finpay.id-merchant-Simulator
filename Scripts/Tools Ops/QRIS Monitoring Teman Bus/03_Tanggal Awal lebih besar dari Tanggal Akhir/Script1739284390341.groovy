...
WebUI.setText(findTestObject('Tools Ops/QRIS Monitoring Teman Bus/input_StartDate'), '10-06-2024')

WebUI.click(findTestObject('Tools Ops/QRIS Monitoring Teman Bus/activeDay'))

WebUI.setText(findTestObject('Tools Ops/QRIS Monitoring Teman Bus/input_EndDate'), '01-06-2024')
...
WebUI.verifyElementText(findTestObject('Tools Ops/QRIS Monitoring Teman Bus/content_PopUpMsg'), rc_02)
